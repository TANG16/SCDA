...
%     delta.t = [0.25, 0.015, 0.00085, 0.06, 0.05]; %    
    delta.t = [0.25, 0.015, 0.00085, 0.04, 0.0]; %    
    if (arg2 > 0)
%         delta_HMM.h = 0.3; % 0.2599
        delta_HMM.h = 0.25;
% % %         delta_HMM.t = [0.05, 0.008, 0.0008, 0.07, 0.1]; %   
% %         delta_HMM.t = [0.05, 0.008, 0.0008, 0.0, 0.01]; %   
        delta_HMM.t = [0.07, 0.008, 0.001, 0.04, 0.0]; %   
%         delta_HMM.t = [0.01, 0.001, 0.0001, 0.02, 0.04]; %   
    else 
        delta_HMM = [];
    end
    if (arg3 > 0)    
        delta_HMM_adapt.h = 0.3;
%         delta_HMM_adapt.t = [0.25, 0.007, 0.00085, 0.07, 0.08];
        delta_HMM_adapt.t = [0.05, 0.002, 0.00085, 0.04, 0.08];
    else
        delta_HMM_adapt = [];
    end
end
