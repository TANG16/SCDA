function try_SV_param_linux(arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7)
% clear all
close all
...
% %         mean(A_H_DA) = 0.3734
        ...
        h = h_init;
        [theta, delta] = SV_initialise(arg0, 1);
        % theta = theta_true;
...
%         theta = theta_init2;
        ...
        h = h_init;
        [theta, delta] = SV_initialise(arg0, 3);
...
%         theta = theta_init3;
        ...
        h = h_init;
        [theta, delta] = SV_initialise(arg0, 4);
...
%             [theta, A_theta] = update_theta_HMM_RW_adapt(y, h, theta, mid, hyper, delta.t);           
             [h, acc, A_h] = update_h_HMM_adapt(y, h, theta, delta.h, mid_inv);
            [theta, A_theta] = update_theta_HMM_RW_adapt(y, h, theta, mid_inv, hyper, delta.t);
...
%             [theta, A_theta] = update_theta_HMM_RW_adapt(y, h, theta, mid, hyper, delta.t);           
        ...
        mean_H_HMM_adapt_eff = mean(H_HMM_adapt_eff);

        ESS_theta_HMM_adapt_eff_40 = ESS(theta_HMM_adapt_eff,40);
        ESS_theta_HMM_adapt_eff_100 = ESS(theta_HMM_adapt_eff,100);
        ...
        save(name,...
            ...
            'mean_H_HMM_adapt_eff',...
            'theta_HMM_adapt_eff',...
            'accept_HMM_adapt_eff',...
            'A_H_HMM_adapt_eff',...
            'A_theta_HMM_adapt_eff',...
            'ESS_theta_HMM_adapt_eff_40','ESS_theta_HMM_adapt_eff_100','ESS_theta_HMM_adapt_eff_1000','ESS_theta_HMM_adapt_eff_sig',...
            'ESS_H_HMM_adapt_eff_40','ESS_H_HMM_adapt_eff_100','ESS_H_HMM_adapt_eff_1000','ESS_H_HMM_adapt_eff_sig',...    
            'time_HMM_adapt_eff');   
    end    
end