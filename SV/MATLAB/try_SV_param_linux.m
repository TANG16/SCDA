function try_SV_param_linux(arg1,arg2,arg3,arg4)
% clear all
close all
...
%% SAVE
name = 'SV_results_param_arg.mat';
save(name,'y','h_true','theta_true','delta','hyper');
...
if arg1
    ...
    'A_H_DA',...
    'A_phi_DA',...
    'ESS_theta_DA_40','ESS_theta_DA_100','ESS_theta_DA_1000',...
    'ESS_H_DA_40','ESS_H_DA_100','ESS_H_DA_1000',...       
    'time_DA','-append');    
end
...
if arg2
    ...
    ESS_theta_DM_RW_40 = ESS(theta_DA_RW,40);
    ...
    'A_H_DA_RW',...
    'A_theta_DA_RW',...
    'ESS_theta_DA_RW_40','ESS_theta_DA_RW_100','ESS_theta_DA_RW_1000',...
    'ESS_H_DA_RW_40','ESS_H_DA_RW_100','ESS_H_DA_RW_1000',...       
    'time_DA_RW','-append');
end
...
%     for ii = 1:1:M 
    ...
    'A_H_HMM',...
    'A_theta_HMM',...
    'ESS_theta_HMM_40','ESS_theta_HMM_100','ESS_theta_HMM_1000',...
    'ESS_H_HMM_40','ESS_H_HMM_100','ESS_H_HMM_1000',...    
    'time_HMM','-append');
end
...
%     'mean_H_DA','mean_H_DA_RW','mean_H_HMM','mean_H_HMM_shift',...
%     'theta_DA','theta_DA_RW','theta_HMM','theta_HMM_shift',...
%     'accept_DA','accept_DA_RW','accept_HMM','accept_HMM_shift',...
%     'A_H_DA','A_H_DA_RW','A_H_HMM','A_H_HMM_shift',...
%     'A_phi_DA','A_theta_DA_RW','A_theta_HMM','A_theta_HMM_shift',...
%     'time_DA','time_DA_RW','time_HMM','time_HMM_shift','-append');
