function fname = print_table_results_theta_and_h(path, data_name, method,...
...
%% THETA
    ...
    fprintf(FID, '\\center \n');
    fprintf(FID, ['\\begin{tabular}{cc ccc } \n']);
    fprintf(FID, [' Method & & '...
        ' $\\mu$ & ','$\\phi$ &','$\\sigma^2$',...        
        ' \\\\ \\hline  \\hline\n']);
...
%         fprintf(FID,' \\\\  [1.3ex] \n');        
    ...
    fprintf(FID, ['\\multicolumn{5}{p{6cm}}{\\footnotesize{ESS: at lag equal to the ' ...
    'lowest order at which sample autocorrelation is not significant.}}  \\\\ \n']);
    fprintf(FID, ['\\multicolumn{5}{p{6cm}}{\\footnotesize{Computing times '...
    ...
    label = ['\\label{tab:SV_results_theta',data_name,'}  \n'];
    fprintf(FID, label);
