...
if (save_on) {
  save(file=paste("SV_HMM_adapt_Nq",toString(N_q),"_T",toString(T),"_selected.RData",sep=""),
       y, h_true, param, 
       sv_model_HMM_adapt, time_init_HMM_adapt, time_sample_HMM_adapt, mat_names_HMM_adapt,
...
# if (save_on) {
#   save(file=paste("SV_HMM_adapt_Nq",toString(N_q),"_T",toString(T),".RData",sep=""),
