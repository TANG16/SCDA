...
phi=0.6           # persistence parameter of AR(1)-component in covariate process  #  ETA in the paper
alpha=2           # factor in sine-shaped deterministic trend in covariate process # GAMMA in the paper
mu=25 
