...
if (save_on) {
  save(output1, time_sample_HMM, mod, time_init_HMM, file = paste("Results/Heron_HMM_approx_iter",toString(iter),"_ada",toString(ada),"_linux_bin",toString(bin_size),"_bin3",toString(bin_size3),"_unifprior.RData",sep=""))
}
