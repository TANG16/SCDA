function [N, newlikhood, accept] = BKM_updateN_v3(fn_BKM_calclikhood,  fn_BKM_cov, N, oldlikhood, theta, deltaN, priorN)    
...
%     Na = N(2,:);
    ...
    for t = 1:2    
        ...
        if (N(1,t) > 0)
            ...
            % Prior (Poisson) terms are alread in the state space likelood 
