function [N, theta, accept] = BKM_update_NRW_NEW(N, theta, prior, delta, y, m, f, stdT, logfact)
...
% Gibbs update for sigma2y
    ...
    [N_new, accept] = BKM_updateN_NEW(fn_BKM_cov, N, theta, y, delta.N, prior.N, logfact);
