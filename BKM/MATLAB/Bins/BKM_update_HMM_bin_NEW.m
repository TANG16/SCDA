function [N, theta, accept] = BKM_update_HMM_bin_NEW(N, theta, prior, delta, y, m, f, stdT, bin, logfact)
...
% Gibbs update for sigma2y
    ...
    for ii = [1:3,5:7]
        ...
        newlikhood = BKM_calclikhood_HMM_bin_NEW(N, theta, y, m, f, stdT, prior.N, bin, logfact);
