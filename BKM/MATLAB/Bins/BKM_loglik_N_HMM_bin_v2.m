function loglik = BKM_loglik_N_HMM_bin_v2(y, Na, Na_prev, Na_prev2, phia, phi1, rho, sigy, bin, logfact)
...
%     IND = 1:N_bin;
    ...
    IND_ok = ((bin +  Na_prev - Na) > 0);
    bin_ok = bin(IND_ok);
    P(IND_ok) = exp(Na*log(phia) + (bin_ok + Na_prev - Na)*log(1-phia) + ...
                  logfact(bin_ok + Na_prev + 1) - ...
                  logfact(bin_ok + Na_prev - Na + 1) - ...
                  logfact(Na + 1));
