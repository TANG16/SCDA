function [N, theta, accept, A_sum] = BKM_update_HMM_bin_v2(N, theta, prior, delta, y, m, f, stdT, bin, logfact)
...
% Gibbs update for sigma2y
    ...
    [N_new, accept, A_sum] = BKM_updateN_HMM_bin_v2(fn_BKM_cov, N, theta, y, delta.N, prior.N, bin, logfact);
    N = N_new;  
    oldlikhood = BKM_calclikhood_HMM_bin(N, theta, y, m, f, stdT, prior.N, bin, logfact);
    ...
    for ii = [1:3,5:7]
        ...
        newlikhood = BKM_calclikhood_HMM_bin(N, theta, y, m, f, stdT, prior.N, bin, logfact);
