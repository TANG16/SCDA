function [N, theta, accept, A_sum] = BKM_update_HMM_debug(N, theta, prior, delta, y, m, f, stdT, N_max, logfact)
...
% Gibbs update for sigma2y
    ...
    [N_new, accept, A_sum] = BKM_updateN_HMM_debug(fn_BKM_cov, N, theta, y, delta.N, prior.N, N_max, logfact);
    N = N_new;  
