...
%                 num = num + BKM_loglik_N_HMM_v2(N(t+2), N(t+1), priorN(1),...
%                       phia(t+1), 1, 1, sigy, N_max, logfact);
%                 den = den +  BKM_loglik_N_HMM_v2(N(t+2), N(t+1), priorN(1),...
%                       phia(t+1), 1, 1, sigy, N_max, logfact);  
%             end
              
            if (t == 2)  
                num = num + BKM_loglik_N_HMM_v2(N(t+1), N(t), priorN(1),...
                      phia(t), 1, 1, sigy, N_max, logfact);
                den = den +  BKM_loglik_N_HMM_v2(N(t+1), Na_old, priorN(1),...
                      phia(t), 1, 1, sigy, N_max, logfact);
...
%                       phia(t), phi1(t-1), rho(t-1), sigy, N_max, logfact);
%                 num = num + BKM_loglik_N_HMM_EndCond(N(t-1), phi1(t-1), rho(t-1), N_max, logfact);
%                 den = den + BKM_loglik_N_HMM_EndCond(N(t-1), phi1(t-1), rho(t-1), N_max, logfact);

%                 num = num + BKM_loglik_N_HMM_v2(1, 0, N(t),...
%                       phia(t+1), phi1(t), rho(t), sigy, N_max, logfact);
%                 den = den +  BKM_loglik_N_HMM_v2(N(t+2), N(t+1), Na_old,...
%                       phia(t+1), phi1(t), rho(t), sigy, N_max, logfact);
% %                 num = num + BKM_loglik_N_HMM_EndCond(N(t), phi1(t), rho(t), N_max, logfact);
% %                 den = den + BKM_loglik_N_HMM_EndCond(Na_old, phi1(t), rho(t), N_max, logfact);
...
%                       phia(t+1), phi1(t), rho(t), sigy, N_max, logfact);      
                ...
                den = den + BKM_loglik_N_HMM_EndCond(Na_old, phi1(t), rho(t), N_max, logfact);
            elseif (t == 3)
                num = BKM_loglik_N_HMM_v2(N(t), N(t-1), priorN(1),...
                      phia(t-1), 1, 1, sigy, N_max, logfact) ... 
                      -  0.5*( ((y(t)-N(t)).^2)/sigy);
                den = BKM_loglik_N_HMM_v2(Na_old, N(t-1), priorN(1),...
                      phia(t-1), 1, 1, sigy, N_max, logfact) ...
                      -  0.5*(((y(t)-Na_old).^2)/sigy); 
