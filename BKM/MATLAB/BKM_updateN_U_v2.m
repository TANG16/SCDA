function [N, accept, A_sum] = BKM_updateN_U_v2(fn_BKM_cov, N, theta, y, deltaN, priorN, logfact)    
...
%                 loglam = log(Na_old) + log(rho(t)) + log(phi1(t));
                ...
                den = den + Na_old*log(phia(t-1)) - Na_old*log(1-phia(t-1)) - ...                      
                 ...
                 if ((N(1,t)+N(2,t) >= N(2,t+1)) && (N(1,t)+Na_old >= N(2,t+1)))
%%                 num = - 0.5*(log(2*pi) + log(sigy) + ((y(t)-N(2,t))^2)/(sigy)) ...
%                      + log(binopdf(N(2,t),N(1,t-1)+N(2,t-1),phia(t-1))) ...
%                      + log(binopdf(N(2,t+1),N(1,t)+N(2,t),phia(t))) ...
%                      + log(poisspdf(N(1,t+1),N(2,t).*rho(t).*phi1(t)));
...
%                       logfact(N(1,t-1)+N(2,t-1) - N(2,t) + 1) - ...
%                       logfact(N(2,t) + 1);
%                 num = num + N(2,t+1)*log(phia(t)) + (N(1,t)+N(2,t)-N(2,t+1))*log(1-phia(t)) + ...
%                       logfact(N(1,t)+N(2,t) + 1) - ...
%                       logfact(N(1,t)+N(2,t) - N(2,t+1) + 1) - ...
%                       logfact(N(2,t+1) + 1);
...
%                       logfact(N(1,t-1)+N(2,t-1) - Na_old + 1) - ...
%                       logfact(Na_old + 1); 
%                 den = den + N(2,t+1)*log(phia(t)) + (N(1,t)+Na_old-N(2,t+1))*log(1-phia(t)) + ...
...
%                       logfact(N(2,t+1) + 1); 
                 ...
                 %% with cancelation
                    ...
                    num = num + N(2,t)*log(phia(t-1)) -N(2,t)*log(1-phia(t-1)) - ...
                          logfact(N(1,t-1)+N(2,t-1) - N(2,t) + 1) - ...
                          logfact(N(2,t) + 1);      
                    num = num + (N(1,t)+N(2,t)-N(2,t+1))*log(1-phia(t)) + ...
                          logfact(N(1,t)+N(2,t) + 1) - ...
                          logfact(N(1,t)+N(2,t) - N(2,t+1) + 1);
                    ...
                    den = den + Na_old*log(phia(t-1)) - Na_old*log(1-phia(t-1)) - ...                      
                          logfact(N(1,t-1)+N(2,t-1) - Na_old + 1) - ...
                          logfact(Na_old + 1);        
                    den = den + (N(1,t)+Na_old-N(2,t+1))*log(1-phia(t)) + ...
                          logfact(N(1,t)+Na_old + 1) - ...
                          logfact(N(1,t)+Na_old - N(2,t+1) + 1);   
                 end
            end
