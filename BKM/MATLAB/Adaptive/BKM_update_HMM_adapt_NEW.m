function [N, theta, accept] = BKM_update_HMM_adapt_NEW(N, theta, prior, delta, y, m, f, stdT, mid, logfact)
...
% Gibbs update for sigma2y
    ...
    [N_new, accept] = BKM_updateN_HMM_adapt_NEW(fn_BKM_cov, N, theta, y, delta.N, prior.N, mid, logfact);
    N = N_new;  
    oldlikhood = BKM_calclikhood_HMM_adapt_NEW(N, theta, y, m, f, stdT, prior.N, mid, logfact);
    ...
    for ii = [1:3,5:7]
        ...
        newlikhood = BKM_calclikhood_HMM_adapt_NEW(N, theta, y, m, f, stdT, prior.N, mid, logfact);
