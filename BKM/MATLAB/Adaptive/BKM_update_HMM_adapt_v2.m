function [N, theta, accept, A_sum] = BKM_update_HMM_adapt_v2(N, theta, prior, delta, y, m, f, stdT, mid, logfact)
...
% Gibbs update for sigma2y
    ...
    [N_new, accept, A_sum] = BKM_updateN_HMM_adapt_v2(fn_BKM_cov, N, theta, y, delta.N, prior.N, mid, logfact);
    N = N_new;  
    oldlikhood = BKM_calclikhood_HMM_adapt(N, theta, y, m, f, stdT, prior.N, mid, logfact);
