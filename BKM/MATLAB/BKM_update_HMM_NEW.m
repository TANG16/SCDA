function [N, theta, accept] = BKM_update_HMM_NEW(N, theta, prior, delta, y, m, f, stdT, N_max, logfact)
...
% Gibbs update for sigma2y
    ...
    [N_new, accept] = BKM_updateN_HMM_NEW(fn_BKM_cov, N, theta, y, delta.N, prior.N, N_max, logfact);
  
    N = N_new;  
% if false  
    oldlikhood = BKM_calclikhood_HMM_NEW(N, theta, y, m, f, stdT, prior.N, N_max, logfact);
    ...
    for ii = [1:3,5:7]
        ...
        newlikhood = BKM_calclikhood_HMM_NEW(N, theta, y, m, f, stdT, prior.N, N_max, logfact);
